...
$conn->close();
 ...
 else
 {
    ...
    echo " <li><a id='prvi' href='#'><i class='fas fa-envelope'></i>Kontakt</a></li>";
...
$conn->close();
    ...
    echo " <li><a href='Novosti.php'  id='prvi'><i class='fas fa-newspaper'></i>Novosti</a></li>";
...
if ($result->num_rows > 0) {
    ...
    die("Connection failed: " . $conn->connect_error);
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<div  class='novost'><div class='div2'><img src='".$row["slika"]."' ></div><div class='div8'>
          ...
          echo "<div class='right'><a class='ddn' href='DodajNovost.php'><i class='fas fa-plus'></i>Dodajte novost</a></div>";
    ...
    die("Connection failed: " . $conn->connect_error);
                ...
                echo" <div style='text-align:center'><a class='btn11' href='VasiPacijenti.php'>Pogledaj sve<i class='fas fa-users'></i></a></div>";
                    echo "</div>";
    ...
    die("Connection failed: " . $conn->connect_error);
                ...
                if ($result->num_rows > 0) {
                   ...
                   echo "<p ><span style='margin-left:7%;'>Datum</span> <span style='margin-left:26%;'>Vreme</span></p>";
                    ...
                    echo" <div style='text-align:center'><a  class='btn12' href='RasporedDoktora.php?Id=".$jmbg."'>Pogledaj sve<i class='fas fa-calendar-alt'></i></a></div>";
                    echo "</div>";
